...
/* Hide the link text while keeping icons visible */
...
.sidebar.collapsed .nav-link i {
  margin-right: 0; /* remove the gap for text */
}
...
@media (max-width: 576px) {
  /* Make the stats cards full width on very small screens */
  .stat-card {
    margin-bottom: 1rem;
  }
}
